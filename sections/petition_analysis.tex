...
It should be noted, that on average the number of followers is 10x higher for users that do not use campaign hashtag together with petition URL compared to campaign activists.
