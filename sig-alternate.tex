...
% Climate change
Social media has become one of the most important platforms to support the debate on climate change.
% Campaigns and e-petitioning
In particular, Twitter enhances information dissemination for running various types of public environmental campaigns.
Yet, e-petition dynamics of these campaigns on social platforms still remain largely unexplored.
% Role of the petitions in the environmental campaigns
In this paper we try to answer what drives a petition promoted by an environmental campaign to attain a required number of signatures.
% Petition success based on the campaign or Twitter activity
We present an analysis of e-petitions and identify that the number of users, tweets and retweets posted about the petition on Twitter correlate with its success, as well as, the required number of signatures. Moreover, we have discovered that campaigns with a high user engagement are the most active in promoting petitions on Twitter.
% Findings...
Finally, we present an annotated corpus of petitions posted by the environmental campaigns together with corresponding tweets.
