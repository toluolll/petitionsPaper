...
% Climate change
Social media became an instrument to support a controversial climate change discourse.
...
In this paper, we present an analysis of public environmental campaigns through the prism of created and promoted petitions and their success. 
% Petition success based on the campaign or Twitter activity
Moreover, we have separated e-petition evidence within campaigns from its overall Twitter presence.
% Findings...
We have observed differences in success/failure ratios for general types of petitioning and crowdfunding. Moreover, we propose a generic protocol for petition success prediction based on its Twitter presence which reveals social features to dominate the success.
